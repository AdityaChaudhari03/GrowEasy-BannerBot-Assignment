  ...
  return (
    <div className={`relative ${background} rounded-lg shadow-md`}>
      ...
      <div className="absolute inset-0 p-4 bg-black bg-opacity-50 rounded-lg flex flex-col justify-between">
        ...
        <button className="self-start bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white py-1 px-4 rounded-lg mt-2 shadow-md hover:opacity-90 transition-opacity">
  {cta}
</button>
      </div>
    </div>
